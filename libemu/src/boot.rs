...
// #![allow(dead_code)]
// use crate::{
//   generic::{arch::address::Address, device::Device, memory::rom::Rom, share::Shared},
//   hardware::Bus,
// };

// pub type Boot = Rom<u8, 0x100>;
...
//     let boot: Shared<dyn Device<u16, u8>> = self.boot.clone().to_dynamic();
//     let ctrl: Shared<dyn Device<u16, u8>> = self.ctrl.clone().to_dynamic();

//     bus.map(0x0000..=0x00ff, boot);
//     bus.map(0xff50..=0xff50, ctrl);
//   }
// }
